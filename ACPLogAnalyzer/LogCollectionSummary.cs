...
namespace ACPLogAnalyzer
{
    ...
    public class LogCollectionSummary
    {
        ...
        public List<string> UniqueTargets
        {
            get
            {
                try
                {
                    ...
                    return result.Distinct().ToList();  // Distinct() removes duplicates
                }
                catch
                {
                }
        ...
        /// </summary>
        public double ImagingTimeAsPercentageOfRunTime { get { return Math.Round(100 * (ImagingTime / RunTimeMinusWaits), 0); } }
        ...
        public double AverageAutoFocusTime
        {
            get
            {
                try
                {
                    ...
                    return Math.Round(result.ToList().Average(), 0);
                }
                catch
                {
                }
        ...
        public double AverageFwhm
        {
            get
            {
                try
                {
                    ...
                    return Math.Round(result.ToList().Average(), 2);
                }
                catch
                {
                }
        ...
        /// <summary>
        /// Average all-sky plate solve time for all targets in all logs
        /// </summary>
        public double AverageAllSkyPlateSolveTime
        {
            get
            {
                try
                {
                    var result =
                        ...
                        select log into logs                                        // ...select all the logs with good stats
                        from target in logs.Targets                                 // From all targets...
                        where target.AvgAllSkyPlateSolveTime.TotalSeconds != 0      // ...and there's valid data...
                        select target.AvgAllSkyPlateSolveTime.TotalSeconds;         // ...select each value into a list
        ...
        public TimeSpan AverageAllSkyPlateSolveTimeAsTimeSpan
        {
            get
            {
                try
                {
                    return TimeSpan.FromSeconds(AverageAllSkyPlateSolveTime);
                }
                catch
                {
                }
        ...
        /// <summary>
        /// Count of successful all-sky plate solves for all targets in all logs
        /// </summary>
        public int SuccessfulAllSkyPlateSolveCount
        {
            get
            {
                try
                {
                    var result =
                        ...
                        select log into logs                            // ...select all the logs with good stats
                        from target in logs.Targets                     // From all targets...
                        where target.SuccessfulAllSkyPlateSolves != 0   // ...and there's valid data...
                        select target.SuccessfulAllSkyPlateSolves;      // ...select each value into a list
        ...
        /// <summary>
        /// Count of failed all-sky plate solves for all targets in all logs
        /// </summary>
        public int UnsuccessfulAllSkyPlateSolveCount
        {
            get
            {
                try
                {
                    var result =
                        ...
                        select log into logs                                // ...select all the logs with good stats
                        from target in logs.Targets                         // From all targets...
                        where target.UnsuccessfulAllSkyPlateSolves != 0     // ...and there's valid data...
                        select target.UnsuccessfulAllSkyPlateSolves;        // ...select each value into a list
